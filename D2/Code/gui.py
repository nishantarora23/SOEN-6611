...
class MetricsApp:
    ...
    def __init__(self, master):
        ...
        visualize_button = ttk.Button(options_frame, text="Visualize Data", command=self.visualize_data, width=25)
        ...
        # Export Button
        self.export_button = ttk.Button(options_frame, text="Export Data", command=self.export_data_to_csv, width=25)
        self.export_button.grid(row=6, column=0, padx=5, pady=5, sticky="ew")
    ...
    def export_data_to_csv(self):
        """Export data from the entry field to a CSV file."""
